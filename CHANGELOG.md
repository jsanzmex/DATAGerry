...
- A new index was added to the `framework.objects` collection to improve query performance. Now, when the database is created, the code automatically generates this new index:
    {
		"v" : 2,
		"key" : {
			"type_id" : 1,
